        ...
        <div className="w-full max-w-5xl bg-slate-200 lg:bg-transparent">
            <div className="w-full h-36 lg:h-56 flex p-5 gap-3">
                ...
                <div className="flex flex-col gap-2 justify-center">
                    ...
                    <div>
                        <div className="text-base lg:text-lg font-medium">{data.spesialis}</div>
                        <div className="text-base lg:text-lg font-regular">{data.rs}</div>
                    </div>
                </div>
            </div>
