...
function ProfileCard ({nama, tgl_lahir, no_telepon}) {
    return (
        <div className="px-5 py-5 bg-gray-100 flex rounded-md shadow-sm mt-2 space-y-6 border border-gray-200 hover:border-r-5 hover:border-b-5 hover:border-gray-500 transform hover:scale-101 transition duration-300 lg:m-7 justify-items-center">  
