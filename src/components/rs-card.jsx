 ...
 function HospitalCard ({jarak, name, area, alamat}) {
    return (
        <div className='w-full flex px-5 py-3 bg-gray-100 rounded-md shadow-sm mt-8 space-y-px border border-gray-200 hover:border-r-5 hover:border-b-5 hover:border-gray-500 transform hover:scale-101 transition duration-300 sm:px-6 lg:px-6'>
