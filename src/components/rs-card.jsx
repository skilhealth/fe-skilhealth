 ...
 function HospitalCard ({jarak, name, area, alamat}) {
    return (
        <div className='px-5 py-5 bg-gray-100 flex rounded-md shadow-sm mt-8 space-y-px border border-gray-200 hover:border-r-5 hover:border-b-5 hover:border-gray-500 transform hover:scale-101 transition duration-300 w-full focus:z-10 sm:px-6 lg:px-8'>
