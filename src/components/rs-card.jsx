 ...
 function HospitalCard ({jarak, name, area, alamat}) {
    return (
        <div className='px-2 py-3 bg-gray-100 flex rounded-md shadow-sm mt-8 space-y-px border border-gray-200 hover:border-r-5 hover:border-b-5 hover:border-gray-500 transform hover:scale-101 transition duration-300  h-2/3 focus:z-10 sm:px-6 lg:px-6'>
