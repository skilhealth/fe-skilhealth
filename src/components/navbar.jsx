    ...
    return (
        <nav className=" bg-red-700 w-full h-20 text-lg font-bold">
            <div className="w-full h-full flex justify-between p-4">
                ...
                <div className="h-full aspect-square flex flex-col items-center justify-center gap-2" onClick={handleNavbar}>
            ...
            <ul className={`w-full text-red-700 flex-col px-4 absolute ${navbar ? "hidden" : "flex"}`}>
                ...
                <li className="py-4 w-full text-center border-slate-200 border-b-2">Forum</li>
                {
                    (isLogin) ? (
                        <div>
                            <li className="py-4 w-full text-center border-slate-200 border-b-2">Register</li>
                            <li className="py-4 w-full text-center border-slate-200 border-b-2">Login</li>
                        </div>

                    ) : (
                        <div>
                            <li className="py-4 w-full text-center border-slate-200 border-b-2">Profil</li>
                            <li className="py-4 w-full text-center border-slate-200 border-b-2">Logout</li>
                        </div>
                    )
                }
<<<<<<< HEAD
