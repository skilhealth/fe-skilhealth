            ...
            <div className="flex text-xs gap-3">
                {
                    jadwal.map((item, index) => (
                        <label key={index} className={`flex flex-col w-max rounded-md p-2 border-2 hover:opacity-70 ${(selectOption === index) ? "transition duration-200 border-red-700 bg-red-700 text-white" : "border-black"}`}>
