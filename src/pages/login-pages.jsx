  ...
  return (
    <div className="min-h-screen flex justify-center bg-white-q00 py-12 px-4 sm:px-6 items-center lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="btn-wrapper item-center sm:px-10 flex justify-center items-center">
          <img alt="..." className="flex w-40 h-40" src={imgSkilhealth} />
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className='justify-between flex'>
            <label className="flex items-center cursor-pointer ">
              <input id="customCheckLogin" type="checkbox" className="form-checkbox text-gray-800 w-5 h-5 ease-linear transition-all duration-150" defaultChecked />
        ...
        <a href="../register" className=" justify-center font-sans text-lg flex w-full">Belum Punya Akun?</a>
      </div>
    </div>
  );
};
