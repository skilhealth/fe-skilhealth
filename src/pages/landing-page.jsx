      ...
      <div className="p-4 lg:px-24 lg:py-7">
        <div className="flex w-full pl-4 bg-red-700 rounded-lg items-center  h-48 lg:pl-20 lg:h-80 justify-between overflow-hidden">
          <div className="text-white w-full max-w-[168px] lg:max-w-lg flex flex-col gap-4">
            <div className="text-white flex gap-2 items-end">
              <p className="text-xl font-bold lg:text-4xl align-text-bottom">Halo</p>
        ...
        <div className="my-4 lg:my-7">
          ...
          <div className="flex flex-wrap justify-center gap-4 ">
            <Link to="/doctor/search" className="flex flex-col items-center hover:opacity-70 transition duration-200">
            ...
            <Link to="/ujilab" className="flex flex-col items-center hover:opacity-70 transition duration-200">
            ...
            <Link to="/ambulan" className="flex flex-col items-center hover:opacity-70 transition duration-200">
              <div className="p-3 bg-red-700 lg:h-28 rounded-lg aspect-square flex h-20">
                <img src={Ambulan} alt="" />
              </div>
              <div className="w-20 text-center font-semibold mt-2">
            ...
            <Link to="/forum" className="flex flex-col items-center hover:opacity-70 transition duration-200">
              <div className="p-3 bg-red-700 lg:h-28 rounded-lg aspect-square flex h-20">
                <img src={forumPng} alt="" />
              </div>
              <div className="w-20 text-center font-semibold mt-2">Forum</div>
            </Link>
            <Link to="/booking" className="flex flex-col items-center hover:opacity-70 transition duration-200">
              <div className="p-3 bg-red-700 lg:h-28 rounded-lg aspect-square flex h-20">
